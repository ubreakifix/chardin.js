...
(function() {
  ...
  (function($, window) {
    ...
    chardinJs = (function() {
      ...
      chardinJs.prototype.start = function(page) {
        var el, _i, _len, _ref;
        if (this._overlay_visible()) {
          return false;
        }
        this._add_overlay_layer();
        _ref = this.$el.find('*[' + (page != null ? 'data-intro-page=' + page : 'data-intro') + ']:visible');
      ...
      chardinJs.prototype.toggle = function(page) {
        if (!this._overlay_visible()) {
          return this.start(page);
        } else {
          return this.stop();
        }
      };
